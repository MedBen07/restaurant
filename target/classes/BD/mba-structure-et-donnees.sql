...
CREATE DATABASE IF NOT EXISTS restaurantmba DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
...
INSERT INTO T_Categorie (cat_id, cat_nom, cat_type) VALUES
(5, 'Desserts', 'plat'),
(1, 'Entrées', 'plat'),
(4, 'Fromages', 'plat'),
(2, 'Poissons', 'plat'),
...
INSERT INTO T_Plat (pla_id, pla_nom, pla_detail, pla_portion, pla_prix, pla_cat_id_ce) VALUES
...
INSERT INTO T_Vin (vin_id, vin_nom, vin_detail, vin_provenance, vin_annee, vin_prix, vin_cat_id_ce) VALUES
...
ALTER TABLE T_Plat
  ADD CONSTRAINT plat_ibfk_1 FOREIGN KEY (pla_cat_id_ce) REFERENCES T_Categorie (cat_id);

ALTER TABLE T_Vin
  ADD CONSTRAINT vin_ibfk_1 FOREIGN KEY (vin_cat_id_ce) REFERENCES T_Categorie (cat_id);
