...
<head>
    ...
    <meta name="description" content="Menu du restaurant à Montréal. Un menu eclectique et raffiné, combinant créativité et tradition. Produits locaux et spécialités du terroir québécois. ">
...
<div id="conteneur" class="page-menu">
    <header>
        ...
        <nav class="nav-principale">
            <a href="plat.jsp" class="actif" title="Les menus">
    ...
    <div class="contenu-principal">
        ...
        <dic>
            <ul>
                <li> <h3><span> Nom :  ${sessionScope.reserv.res_nom} </span> </h3>  </li>
                <li> <h3><span> Prénom :  ${sessionScope.reserv.res_prenom} </span> </h3>  </li>
                <li> <h3><span> Courriel :  ${sessionScope.reserv.res_email} </span></h3>  </li>
                <li> <h3><span> Cellulaire :  ${sessionScope.reserv.res_telephone} </span></h3>   </li>
                <li> <h3><span> Nombre de places :  ${sessionScope.reserv.res_nombrepersonne} </span></h3>   </li>
                <li> <h3><span> Date de réservation :  ${sessionScope.reserv.res_date} </span> </h3>  </li>
                <li> <h3><span> Commentaire :  ${sessionScope.reserv.res_message} </span></h3>   </li>
            </ul>
