...
<div id="conteneur" class="page-menu">
    ...
    <div class="contenu-principal">
        <div class="citation">
            <img src="images/menu-citation1.jpg" alt="">
            <blockquote>
        ...
        <div class="carte">
            <section>
                <h2>Entrées</h2>
                <ul>
                 <c:forEach var="tmp" items="${sessionScope.listEntrees}">
                         <li>
                              <span>${tmp.pla_nom} <br><i>${tmp.pla_detail}</i></span>
                              <span class="prix"><i class="article-menu-portion">
                              <c:if test="${tmp.pla_portion > 1}">
                                      (pour  ${tmp.pla_portion} personnes)
                              </c:if>
                              </i>${tmp.pla_prix}</span>
                          </li>
                 </c:forEach>
            ...
            <section>
                ...
                <ul>
                    ...
                    <c:forEach var="tmp" items="${sessionScope.listPoissons}">
                        <li>
                            <span>${tmp.pla_nom} <br><i>${tmp.pla_detail}</i></span>
                            <span class="prix"><i class="article-menu-portion">
                              <c:if test="${tmp.pla_portion > 1}">
            ...
            <section>
                ...
                <ul>
                    ...
                    <c:forEach var="tmp" items="${sessionScope.listViandes}">
                        <li>
                            <span>${tmp.pla_nom} <br><i>${tmp.pla_detail}</i></span>
                            <span class="prix"><i class="article-menu-portion">
                              <c:if test="${tmp.pla_portion > 1}">
            ...
            <section>
                <h2>Fromages</h2>
                <ul>
                    <c:forEach var="tmp" items="${sessionScope.listFromages}">
                        <li>
                            <span>${tmp.pla_nom} <br><i>${tmp.pla_detail}</i></span>
                            <span class="prix"><i class="article-menu-portion">
                              <c:if test="${tmp.pla_portion > 1}">
            ...
            <section>
                <h2>Desserts</h2>
                <ul>
                    <c:forEach var="tmp" items="${sessionScope.listDesserts}">
                        <li>
                            <span>${tmp.pla_nom} <br><i>${tmp.pla_detail}</i></span>
                            <span class="prix"><i class="article-menu-portion">
                              <c:if test="${tmp.pla_portion > 1}">
