...
<div id="conteneur" class="page-vins">
    ...
    <div class="contenu-principal">
        ...
        <form class="frm-recherche" action="TraitementRecherche" method="post">
            <label>Recherche :
                <input type="text" name="origine" value="" placeholder="Par pays (exemples : Québec, France, Espagne)">
            </label>
        </form>
        <div class="carte">

            <section>
                <h2>Voici la liste des Vin ${origine} retrouvées </h2>
                <ul>
                <c:forEach var="fr" items="${sessionScope.listeVin}" >
                   <li>
                        <span>
